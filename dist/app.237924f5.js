...
var mobilelinks = document.querySelector('.navbar__menu');
var navLogo = document.querySelector('#navbar-logo'); // Display the mobile nav
...
menu.addEventListener('click', mobileMenu); // Hightlighting the Nav link on scroll
...
var highlightMenu = function highlightMenu() {
  ...
  var serviceMenu = document.querySelector('#service-page');
  var teamMenu = document.querySelector('#team-page');
  var contactMenu = document.querySelector('#contact-page');
...
window.addEventListener('click', highlightMenu); // CLose Mobile Nav when clicking the menu

var hideMObMenu = function hideMObMenu() {
  var mobBars = document.querySelector('.is-active');
